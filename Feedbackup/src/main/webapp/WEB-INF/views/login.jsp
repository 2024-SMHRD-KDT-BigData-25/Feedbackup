...
<body>
		...
		<img
			...
			alt="logo" class="logo"><br> <br> <br> <br>
		<div class="login_wrapper">
			...
			<form action="/myapp/login" method="post">
				<input type="text" name="id" placeholder="아이디" required
					...
					name="pw" placeholder="비밀번호" required style="width: 260px"><br>

				<div class="checkbox_wrapper">
					<div class="checkbox_container">
						<input type="checkbox" id="auto_login" name="auto_login">
						<label class="checkbox_label" for="auto_login">다음부터 자동으로
							로그인하기</label>
					</div>
					<a href="/myapp/users/signup" class="signup">가입하기</a>
				</div>

				<input type="submit" value="로그인" id="loginBtn"><br> <a
					href="/myapp/users/naverlogin" style="text-decoration: none;">
					<button type="button" id="naverloginBtn">
						<img
							src="${pageContext.request.contextPath}/assets/img/naverlogo.jpg"
							alt="naverlogo" class="naverlogo">네이버 계정으로 로그인
					</button>
				</a><br>

				<div class="link-container">
					<a href="/myapp/users/idfind">아이디 찾기</a> <a
						href="/myapp/users/pwfind">비밀번호 찾기</a>
				</div>
